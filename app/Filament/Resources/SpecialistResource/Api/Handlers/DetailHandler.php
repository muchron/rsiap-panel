...
use App\Filament\Resources\SpecialistResource\Api\Transformers\SpecialistTransformer;
...
class DetailHandler extends Handlers
{
    ...
    public function handler(Request $request)
    {
        ...
        return new SpecialistTransformer($query);
    }
}
